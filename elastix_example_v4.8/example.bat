...
@echo # We write all output in the example output directory.
@echo #
...
@echo #
@echo # elastix \
-f exampleinput/fixed.mhd \
-m exampleinput/moving.mhd \
-fMask exampleinput/mask_fixed.mhd \
-mMask exampleinput/mask_moving.mhd \
-out exampleoutput \
-p exampleinput/parameters_Rigid.txt \
-p exampleinput/parameters_BSpline.txt
...
@echo #
@echo # You may compare result.1.mhd to the solution, which is loca<ted in
...
rem transformix 
-in exampleinput/mask_moving.mhd 
-out exampleoutput 
-tp exampleoutput/TransformParameters.1.txt
